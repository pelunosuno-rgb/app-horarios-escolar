...
st.title("📅 Disponibilidad de horas docentesimport streamlit as st
import pandas as pd
import requests
...
# 2. DEFINICIÓN DE HORAS ESPECÍFICAS DEL LICEO
horas_licio = [
    "08:00 - Primera",
    "08:40 - Segunda",
    "09:30 - Tercera",
        ...
        if not seleccionados:
            ...
            try:
                ...
                if respuesta.status_code == 200:
                    ...
                    st.error("Hubo un error al enviar los datos. Verifique su conexión.")
            except Exception as e:
                st.error(f"Error de conexión: {e}") -import streamlit as st
import pandas as pd
import requests
...
# 2. DEFINICIÓN DE HORAS ESPECÍFICAS DEL LICEO
# He mapeado exactamente las horas que solicitaste
horas_licio = [
    "08:00 - Primera",
    "08:40 - Segunda",
    "09:30 - Tercera",
    ...
    if not nombre or not materias_profe:
        ...
        if not seleccionados:
            ...
            try:
                ...
                st.error(f"Error de conexión: {e}") Liceo IEP")
st.info("ℹ️ **Nota importante:** Las horas seleccionadas son las que tiene disponible para ser asignadas.")
st.markdown("---")
